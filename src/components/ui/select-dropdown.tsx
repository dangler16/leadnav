  ...
  return (
    <div ref={ref} className={cn('relative', className)}>
      ...
      <button
        ...
        disabled={disabled}
        className={cn(
          'flex h-8 w-full items-center justify-between cursor-pointer gap-1.5 text-sm border rounded-md pl-2 pr-1.5 disabled:opacity-50 disabled:cursor-not-allowed outline-none bg-white text-gray-900 transition-colors hover:border-gray-400',
