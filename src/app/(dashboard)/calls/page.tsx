        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-100">
              ...
              <th className="text-left text-sm font-medium text-gray-400 px-3 py-2">Duration</th>
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            {calls.map(call => (
              <tr key={call.id} className="hover:bg-neutral-100 transition-colors">
                ...
                <td className="px-3 py-2 text-gray-500">{formatDuration(call.duration_seconds)}</td>
                <td className="px-3 py-2 text-gray-500 text-xs max-w-[220px] truncate">{call.notes ?? '—'}</td>
                <td className="px-3 py-2 text-xs text-gray-400">{formatDate(call.called_at)}</td>
              </tr>
            ))}
          </tbody>
        </table>
