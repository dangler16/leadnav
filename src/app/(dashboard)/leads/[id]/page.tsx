...
import { Lead, CallLog, Dispute, LeadStatus, CallOutcome, DisputeReason, formatLeadStatusLabel, formatDisputeReason } from '@/lib/types'
import { LeadStatusBadge, DisputeStatusBadge } from '@/components/status-badge'
import { LeadActions } from './lead-actions'
import { ChevronLeft, Phone, AlertCircle, User, Mail, PhoneCall, MapPin, Calendar, DollarSign, Home } from 'lucide-react'
...
export default async function LeadDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [{ data: leadData }, { data: callLogs }, { data: leadDisputes }] = await Promise.all([
